...
const AR = () => {
  ...
  <br />
    ...
    <>
      ...
      >
        Total ECAi {hoveredNADR} cfm&emsp;Individual risk: {hoveredIR}%&emsp;Absolute risk: {hoveredAR}%<br/> OA: {hoveredOA} cfm&emsp;RA: {(supplyAir-hoveredOA).toFixed(1)} cfm ({((supplyAir - hoveredOA) / supplyAir * 100).toFixed(1)}%)&emsp;Filter: {hoveredFilter}%
        </span>
        <br/>
